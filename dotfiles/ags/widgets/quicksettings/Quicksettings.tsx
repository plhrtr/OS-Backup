...
export default function Quicksettings() {
  ...
  const quicksettingsPages = [
    <SettingsPage visibleWindow={visibleWindow} previousWindow={mainPanel} />,
    ...
    <NetworkPage visibleWindow={visibleWindow} previousWindow={mainPanel} />,
    <BluetoothPage visibleWindow={visibleWindow} previousWindow={mainPanel} />,
  ];
  ...
  return (
    <popover
      ...
      setup={(self) => {
        self.connect("notify::visible", () => visibleWindow.set(mainPanel));
      }}
    >
      <stack
